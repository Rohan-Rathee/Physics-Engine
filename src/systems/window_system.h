 ...
 * @brief Handles window creation and OpenGL context management.
 *
 * Provides a lightweight wrapper around GLFW for creating the
 * application window, managing the OpenGL context, processing
 * window events, and swapping frame buffers.
 *
 * personal note
 * ------------------------
 * Keep this class focused on the window only.
